...
export * from './reducers/applyVoids.ts'
export * from './reducers/mediaState.ts'
export * from './reducers/journal.ts'
export * from './reducers/log.ts'
...
export * from './export/parse.ts'
// `Clock` et `IdGenerator` vivent DANS le package : ce sont les seuls ports
// que le domaine consomme lui-même (horodatage et identifiants injectés).
// Les autres ports (EventStore, MediaCatalog…) restent côté application.
