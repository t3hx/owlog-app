...
import { progress } from '../reducers/projections.ts'
import { cycles, type Cycle } from '../rules/cycles.ts'
import { advancePercent, COMPLETE_PERCENT } from '../rules/progression.ts'
...
import type { IdGenerator, Clock } from '../ports/Clock.ts'
